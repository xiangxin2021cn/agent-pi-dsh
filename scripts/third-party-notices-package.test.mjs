...
test('repository carries the declared business-core and super-injector licenses', () => {
  ...
  assert.match(notices, /`@dsh-external\/dsh-super-injector` 0\.3\.5/)
  assert.match(notices, /735c212b136e3fb3f9769e1f07266cd091570a55/)
  assert.match(notices, /sha256:49dc9c868704da0e73658976b37b55050bfefa8c22be5606dc290cdb77906f41/)
