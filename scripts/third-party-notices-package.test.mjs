...
test('repository carries the declared business-core and super-injector licenses', () => {
  ...
  assert.match(notices, /`@dsh-external\/dsh-super-injector` 0\.3\.3/)
  assert.match(notices, /f4ef59fb31439225abefe45d6e793235a2a9d5e0/)
  assert.match(notices, /sha256:355238fa8e51bc45c0801066af51e0e122f3b21411b193f601ee54e534391f48/)
  ...
  assert.match(notices, /distributes the complete official `dsh-univer-office` 0\.3\.0/)
  assert.match(notices, /DSH 0\.1\.6-alpha\.1/)
