...
<p align="center">
  ...
  <a href="https://github.com/deepseek-ai/deepseek-harness/releases/tag/dsh-v0.1.5-rc.1"><img src="https://img.shields.io/badge/source-DSH%20dsh--v0.1.5--rc.1-2f6df0?style=flat-square" alt="DSH dsh-v0.1.5-rc.1"></a>
  <a href="https://www.agent-pi.app/docs.html"><img src="https://img.shields.io/badge/文档-Docs-0fb5c9?style=flat-square" alt="Docs"></a>
</p>

<p align="center">
  <a href="https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.6.5/Agent-Pi-DSH-3.6.5-x64.exe"><b>Windows x64</b></a>
  ·
  <a href="https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.6.5/Agent-Pi-DSH-3.6.5-mac-arm64.dmg"><b>macOS arm64</b></a>
  ·
  <a href="https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.6.5/Agent-Pi-DSH-3.6.5-linux-x86_64.AppImage"><b>Linux AppImage</b></a>
  ·
...
| 平台 | 文件 |
| --- | --- |
| Windows x64 | [Agent-Pi-DSH-3.6.5-x64.exe](https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.6.5/Agent-Pi-DSH-3.6.5-x64.exe) |
| macOS Apple Silicon | [Agent-Pi-DSH-3.6.5-mac-arm64.dmg](https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.6.5/Agent-Pi-DSH-3.6.5-mac-arm64.dmg) · [zip](https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.6.5/Agent-Pi-DSH-3.6.5-mac-arm64.zip) |
| Linux x64 | [AppImage](https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.6.5/Agent-Pi-DSH-3.6.5-linux-x86_64.AppImage) · [deb](https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.6.5/Agent-Pi-DSH-3.6.5-linux-amd64.deb) |
| 2.6.5 经典版 | [可与 3.x 并存](https://github.com/xiangxin2021cn/agent-pi/releases/tag/v2.6.5) |

国内镜像（Windows）：[gh-proxy.com](https://gh-proxy.com/https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.6.5/Agent-Pi-DSH-3.6.5-x64.exe) · [ghfast.top](https://ghfast.top/https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.6.5/Agent-Pi-DSH-3.6.5-x64.exe)
...
| 版本 | 一句话 |
| --- | --- |
| [3.6.5](./release/github-notes-3.6.5.md) | DSH alpha.2；专业深度任务说明与交付检查；精简过程展示 |
...
<p align="center">
  ...
  · Always π AI Studio
  · development kernel: dsh-v0.1.5-rc.1
</p>
