...
<p align="center">
  ...
  <a href="https://github.com/deepseek-ai/deepseek-harness/releases/tag/dsh-v0.1.6-alpha.2"><img src="https://img.shields.io/badge/source-DSH%20dsh--v0.1.6--alpha.1-2f6df0?style=flat-square" alt="DSH dsh-v0.1.6-alpha.2"></a>
  <a href="https://www.agent-pi.app/docs.html"><img src="https://img.shields.io/badge/文档-Docs-0fb5c9?style=flat-square" alt="Docs"></a>
</p>

<p align="center">
  <a href="https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.7.0/Agent-Pi-DSH-3.7.0-x64.exe"><b>Windows x64</b></a>
  ·
  <a href="https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.7.0/Agent-Pi-DSH-3.7.0-mac-arm64.dmg"><b>macOS arm64</b></a>
  ·
  <a href="https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.7.0/Agent-Pi-DSH-3.7.0-linux-x86_64.AppImage"><b>Linux AppImage</b></a>
  ·
...
> [!NOTE]
> **3.7.0**：增强事实来源区分与实际文件验收，减少报告技能误触发；升级插件市场 1.47.0、AnySearch 0.1.4 与注入器 0.3.3，保持官方 Univer Office 0.3.0。延续 3.6.7 功能：升级 DSH 0.1.6-alpha.2，专业深度改为只启用、等待实际需求；修复旧对话历史，增加用户手动保存与选用模板，接入 huashu-report 专业报告技能。增加默认关闭、重启生效的官方 Agent Teams 协作开关，修复内置压缩组件的市场状态并增加启动诊断与插件恢复模式。保留可选“专业深度”：自动整理用途、专业要求、依据、格式与验收项，支持中途修订及文件检查。主对话默认精简过程，保留有用进度、错误与交付成果，可切换执行详情。采用官方 V4.1 Flash（`deepseek-flash`）原生文字与图片理解，移除过期灰度模型；模型目录和新对话默认值跟随官方 DSH。保留 Codex 模型与思考等级选择、原生附件入口；内核固定到官方 `dsh-v0.1.6-alpha.2`（`ddefc45fbc`）。安装包包含官方 `dsh-univer-office` 0.3.2 完整插件，保留其原始许可与授权校验。最新已发布版本以 [GitHub Latest Release](https://github.com/xiangxin2021cn/agent-pi-dsh/releases/latest) 为准。

> [!IMPORTANT]
> **3.7.0**：投标流程保持“DSH 唯一执行、工作台轻量控制、一次点击一次派发”；核心依赖固定到 **`dsh-v0.1.6-alpha.2`**（`ddefc45fbc`）。Agent Pi 适配继续位于产品层启动迁移、profile overlay 和 bundle，DSH 官方源码保持干净。DWG 预览由固定源码与工具链重建，并随 Release 提供对应源码归档。
>
...
| **企业级插件** | 技能、工具、工作台页、验收门禁都可以加；官方 Univer Office 0.3.2 随安装包提供，支持软件内 Office 编辑与预览 |
...
| 平台 | 文件 |
| --- | --- |
| Windows x64 | [Agent-Pi-DSH-3.7.0-x64.exe](https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.7.0/Agent-Pi-DSH-3.7.0-x64.exe) |
| macOS Apple Silicon | [Agent-Pi-DSH-3.7.0-mac-arm64.dmg](https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.7.0/Agent-Pi-DSH-3.7.0-mac-arm64.dmg) · [zip](https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.7.0/Agent-Pi-DSH-3.7.0-mac-arm64.zip) |
| Linux x64 | [AppImage](https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.7.0/Agent-Pi-DSH-3.7.0-linux-x86_64.AppImage) · [deb](https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.7.0/Agent-Pi-DSH-3.7.0-linux-amd64.deb) |
| 2.6.5 经典版 | [可与 3.x 并存](https://github.com/xiangxin2021cn/agent-pi/releases/tag/v2.6.5) |

国内镜像（Windows）：[gh-proxy.com](https://gh-proxy.com/https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.7.0/Agent-Pi-DSH-3.7.0-x64.exe) · [ghfast.top](https://ghfast.top/https://github.com/xiangxin2021cn/agent-pi-dsh/releases/download/v3.7.0/Agent-Pi-DSH-3.7.0-x64.exe)
...
| 版本 | 一句话 |
| --- | --- |
| [3.7.0](./release/github-notes-3.7.0.md) | Always π AI studio 独立产品标识；安装包依赖核验 |
...
<p align="center">
  ...
  · Always π AI studio
  · development kernel: dsh-v0.1.6-alpha.2
</p>
