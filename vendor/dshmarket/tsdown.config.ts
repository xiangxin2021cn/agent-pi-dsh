...
const require = createRequire(new URL('../deepseek-harness/package.json', import.meta.url))
const { defineConfig } = await import(pathToFileURL(require.resolve('tsdown')).href)
...
export default defineConfig({
  alias: { marked: fileURLToPath(new URL('../../bundles/tender-host/node_modules/marked/lib/marked.esm.js', import.meta.url)) },
