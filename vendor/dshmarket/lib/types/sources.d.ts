...
/** Catalog display names often omit the npm scope (`dsh-genui` vs `@owner/dsh-genui`). */
export declare function candidatePackageNames(entry: {
    name: string;
    owner?: string;
    npm?: unknown;
}): string[];
/** Every allowBuilds key that can authorize a git-hosted catalog install. */
export declare function gitAllowBuildsKeys(entry: {
    name: string;
    owner?: string;
    npm?: unknown;
}, spec: string): string[];
