 ...
 */
export declare function nameMatchesPackage(name: unknown, packageName: string): boolean;
/**
 ...
 */
export declare function entryMatchesPackage(entry: {
    options?: {
        name?: unknown;
    };
 ...
 */
export declare function packageOfEntryName(name: string): string | null;
