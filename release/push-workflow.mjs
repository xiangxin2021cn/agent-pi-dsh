throw new Error(
  ...
  'For v3.6.1, first run `node release/publish-v3.6.1-release.mjs --create-draft`, then ' +
  '`powershell -File scripts/publish-win-and-trigger-platforms.ps1 -Tag v3.6.1`; ' +
